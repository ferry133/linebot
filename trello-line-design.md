...
| 3 | Sun~Sat 12:00 | 今天距離**結束日**剩 1～7 天（每日） | sponsor + SA/Larry | 「[工項名稱] X 天後到期」 |
...
在 jg-base repo 的 `configmap.yaml` 管理聯絡人：
```yaml
data:2
  line_contacts.json: |
    {
...
| `jg-base/kubernetes/apps/default/trello-notifier/app/cronjobs.yaml` | 三個 CronJob 定義 |
| `jg-base/kubernetes/apps/default/trello-notifier/app/configmap.yaml` | 聯絡人 LINE ID 對應表 |
| `jg-base/kubernetes/apps/default/trello-notifier/app/secret.sops.yaml` | 加密的 API 金鑰 |
